...
Settings FileReader::loadSettings(const string& filename) {
    Settings mySettings;
...
unordered_map<unsigned int, deque<int>> FileReader::lookIntoFuture(string filename, unsigned int shiftAmount) {
